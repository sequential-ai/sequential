...
from sequential_ai.configuration import Configuration
from sequential_ai.api_response import ApiResponse, T as ApiResponseT
import sequential_ai.models
from sequential_ai import rest
from sequential_ai.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sequential_ai.models, klass)
